...
SimpleForm.setup do |config|
  ...
  config.label_text = ->(label, req, _explicit_label) { "#{label} #{req}" }
  ...
  config.wrappers :vertical_form,
    ...
    b.use :input,
          class: 'form-control',
          error_class: 'is-invalid', valid_class: ''
  ...
  config.wrappers :inline_form,
                  tag: 'span', error_class: 'form-group-invalid',
                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
  ...
  config.wrappers :floating_labels_form,
                  tag: 'div', class: 'form-label-group',
                  error_class: 'form-group-invalid',
                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
